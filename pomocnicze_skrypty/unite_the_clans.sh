...
echo "1. Otwórz nowe okno w VSCode."
echo " "
read -p "Masz? Aby kontynuować wciśnij dowolny przycisk i naciśnij enter."
echo " "
echo " "
echo " "
echo "2. Najpierw otwierając w VSCode folder .ssh w którym znajdują się klucze. Folder .ssh znajduje się zawsze w folderze użytkownika."
