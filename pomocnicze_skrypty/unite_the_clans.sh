...
echo " "
echo "Wejdź do swojego folderu .ssh na komputerze u siebie i otwórz terminal/powershell (w  windowsie: kliknij w zakładkę z adresem i wpisz powershell, nacisnij enter."
echo " "
...
echo "a. w nowym oknie VSCode wejdź do katalogu /var/www/flaga"
...
echo " "
echo "Gratulacje! Przejdź do 8 Etapu - instalacja Jupytera:"
