...
echo "1. Otwórz nowe okno w VSCode i zaloguj się na serwer."
echo " "
echo " "
echo " "
echo " "
...
echo " "
echo " "
echo "2. W VSCode w nowo utworzonym oknie otwórz folder .ssh Twojego użytkownika w którym znajdują się klucze. Folder .ssh znajduje się zawsze w folderze użytkownika."
...
echo " "
echo " "
echo "3. Kliknij w lewym górnym roku - zapisz jako / save as i zapisz plik u siebie na komputerze w katalogu .ssh"
echo " "
echo " "
echo " "
echo " "
...
echo " "
echo " "
echo "4. Uzupełniając plik config o nowe informacje - wklej do niego poniższe:
echo " "
echo " "
echo " "
echo "Host xd"
...
echo " "
echo " "
read -p "Jeżeli działa to super :) Aby kontynuować wciśnij dowolny przycisk i naciśnij enter."
echo " "
echo " "
echo " "
echo " "
echo " "
echo " "
echo "5. Nadal wykonując to w drugim oknie VSCode - zapisz plik config, odśwież SSH-Targets i sprawdź połączenie użytkownikiem $the_user w Visual Studio Code wybierając w Remote Explorerze w SSH-Targets opcję 'xd'."
echo " "
echo " "
read -p "Aby kontynuować wciśnij dowolny przycisk i naciśnij enter."
echo "Masz? Udało się połączyć? Super :) Jeżeli nie, to spróbuj naprawić błędy i zrobić to ręcznie:"
echo "a. skasuj zawartość albo w ogóle cały plik known_hosts w katalogu .ssh u siebie na komputerze"
echo "b. usuń pobrany klucz i pobierz go ponownie przez ssh:"
echo " "
echo "W folderze .ssh na komputerze u siebie otwórz terminal/powershell (w  windowsie: kliknij w zakładkę z adresem i wpisz powershell, nacisnij enter."
echo " "
echo "W terminalu/powershellu wpisz komendę:"
echo " "
echo "Dla serwerów na home:"
echo "scp root@$server_ip:/home/$the_user/.ssh/$klucz $klucz"
echo " "
echo "Dla serwerów na AWS: (zamień nazwę klucza 'klucz_xd.pem' na inna, jeżeli inaczej nazwałeś swój klucz do serwera na AWS)"
echo "scp -i klucz_xd.pem ubuntu@$server_ip:/home/$the_user/.ssh/$klucz $klucz"
echo " "
read -p "Znów spróbuj się połączyć. Jeżeli nie udało Ci się połączyć, napisz na discordzie. Aby kontynuować wciśnij dowolny przycisk i naciśnij enter."
echo " "
echo " "
echo " "
echo " "
echo "6. Zostaje modyfikować flagę. Aby dostać się na zajęcia potrzebujesz pokazać ją na zamku (głównym serwerze ZPXD). Przyjść tam i pokazać flagę na której będzie w zakładc '/xd' na Twojej stronie napis 'xD' i do tego cokolwiek zechcesz tam wstawić lub napisać od siebie. To Twoja flaga."
echo "a. w nowym oknie VSCode otwórz katalog /var/www/flaga"
echo "b. otwórz folder templates gdzie są pliki html"
echo "c. wybierz plik xd.html i edytuj 12 linię - dopisz cokolwiek od siebie. Dodaj coś w 12 linii w stylu:"
echo "<h1 style='text-align:center'>xDDD TUTAJ OD SIEBIE DOPISZ :) </h1>"
echo "d. aby przeładować stronę w terminalu wpisz:"
echo "sudo systemctl restart flaga.service"
echo " "
echo "i sprawdź czy Twoja flaga jest widoczna internecie :)"
echo "$domena"/xd
echo " "
echo " "
read -p "Masz? Twoja flaga w zakładce /xd ma xD i coś od siebie? Supeer! Aby kontynuować wciśnij dowolny przycisk i naciśnij enter. Jeżeli nie, napisz na discordzie."
echo " "
echo "Gratulacje! Przejdź na 8 Etap - instalacja Jupytera:"
echo "https://github.com/ZPXD/flaga/blob/main/instrukcje/etap_8_materialy_i_jupyter.md"
echo " "
su $the_user
#cd /var/www
#pwd
