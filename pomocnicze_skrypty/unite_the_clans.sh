...
echo " "
read -p "Spróbuj się połączyć.A by kontynuować wciśnij dowolny przycisk i naciśnij enter."
echo " "
echo " "
echo "Jeżeli nie udało Ci się połączyć, to spróbuj naprawić błędy i zrobić to ręcznie:"
